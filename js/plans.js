...
export const LUNCHBOX = [
  { id: 'l-chicken', title: '닭가슴살 현미 도시락', tags: ['전날준비', '10분'], prep: '전날: 현미밥 소분, 닭가슴살 해동, 브로콜리 데쳐서 통에 담기.',
    ...
    steps: ['브로콜리는 한입 크기로 잘라 끓는 물에 소금 한 꼬집, 1분 데친 뒤 찬물에 식히기', '훈제/수비드 닭가슴살은 전자레인지 40초 또는 팬 중불 1분씩 양면', '김치는 국물 짜서 조금만', '통에 밥·닭가슴살·브로콜리·토마토 순으로 담기', '에어프라이어: 닭가슴살 데우기 170°C 5분(전자레인지보다 촉촉)'] },
  ...
  { id: 'l-sweet', title: '고구마 닭가슴살 샐러드', tags: ['전날준비'], prep: '전날: 고구마 찌고 닭가슴살 준비. 드레싱은 먹기 직전.',
    ...
    steps: ['고구마는 씻어 젖은 키친타월로 감싸 전자레인지 5~6분, 젓가락이 쑥 들어가면 완료', '양상추는 찬물에 5분 담가 아삭하게, 물기 털기', '닭가슴살은 손으로 찢기', '먹기 직전 발사믹 2작은술 + 올리브오일 1작은술 뿌리기', '에어프라이어: 고구마 통째 180°C 25~30분(중간 크기), 또는 1.5cm 조각 200°C 15분'] },
  ...
  { id: 'l-pumpkin', title: '단호박 그릭요거트 볼', tags: ['가벼움', '전날준비'], dairy: true, prep: '단호박 쪄서 냉장. 저녁 예산이 적은 날.',
    ...
    steps: ['단호박은 전자레인지 2분 돌려 살짝 말랑해지면 반 갈라 씨 제거', '랩 씌워 전자레인지 6~7분, 껍질째 먹어도 됨', '식힌 뒤 그릭요거트·견과 올리기', '에어프라이어: 단호박 조각 180°C 15분(찜보다 달아짐)'] },
  { id: 'l-pumpkin-egg', title: '단호박 계란 견과 볼', tags: ['가벼움', '전날준비'], prep: '단호박 찌고 계란 삶아 냉장. 저녁 예산이 적은 날(비유제품).',
    ...
    steps: ['단호박 반 갈라 씨 제거, 랩 씌워 전자레인지 6~7분', '계란은 끓는 물 10분(완숙) 또는 7분(반숙) → 찬물', '단호박 위에 계란·견과, 소금 한 꼬집', '에어프라이어: 단호박 조각 180°C 15분(찜보다 달아짐)'] },
  ...
  { id: 'l-mackerel', title: '고등어구이 정식', tags: ['생선', '15분'], prep: '손질 고등어(순살) 냉동 보관, 전날 냉장 해동. 콩나물은 미리 데쳐두면 5분.',
    ...
    steps: ['고등어는 키친타월로 물기 꼼꼼히 제거(튀지 않게), 소금 한 꼬집', '팬 중불 예열 1분, 기름 없이(고등어 기름으로 충분) 껍질 면 아래로 3분', '뒤집어 2~3분, 살이 하얗게 되고 젓가락이 쉽게 들어가면 완료', '콩나물은 끓는 물에 뚜껑 덮고 3분, 찬물 헹궈 소금·참기름 무치기', '밥·고등어·콩나물·김치·쌈채소로 담기', '에어프라이어: 종이호일 깔고 180°C 12~14분, 7분에 한 번 뒤집기(기름 안 튀고 냄새 덜함)'] },
  { id: 'l-salmon-grill', title: '연어 스테이크 + 구운 채소', tags: ['생선', '15분'], prep: '연어 토막 냉동 보관, 전날 냉장 해동. 채소는 전날 썰어두기.',
    ...
    steps: ['연어에 소금·후추 뿌려 10분 실온', '팬 중강불 예열 1분, 올리브오일 ½작은술', '껍질 면 아래로 4분(뚜껑 덮음), 뒤집어 2분. 옆면이 ⅔ 이상 불투명해지면 완료', '연어 꺼내고 같은 팬 중불에 브로콜리·파프리카·양파 3분, 소금 한 꼬집', '밥 소량과 함께 담기', '에어프라이어: 연어 180°C 10분(두께 2.5cm 기준), 채소는 마지막 5분에 같이 넣기'] },
  { id: 'l-whitefish', title: '흰살생선 채소찜', tags: ['생선', '가벼움', '10분'], prep: '냉동 대구·가자미 순살 사용. 전자레인지만으로 완성.',
    ...
    steps: ['접시에 애호박·버섯 슬라이스 깔고 생선 올리기', '간장 ½큰술 + 물 2큰술 + 다진 마늘 1작은술 섞어 붓고 대파 올리기', '랩 씌워 전자레인지 4~5분. 살이 결대로 갈라지면 완료(찜기는 중불 8분)', '밥과 함께', '에어프라이어: 종이호일에 채소·생선·양념 싸서(파피요트) 180°C 12분'] },
  { id: 'l-tomato-fish', title: '토마토 소스 흰살생선', tags: ['생선', '15분'], prep: '무가당 토마토 소스(저당 파스타 소스) 상비. 전날 만들어 냉장해도 좋음.',
    ...
    steps: ['팬 중불 올리브오일 ½작은술, 양파·버섯 3분 볶기', '토마토 소스 붓고 끓어오르면 생선 넣고 숟가락으로 소스 끼얹기', '뚜껑 덮고 중약불 6분, 생선이 불투명해지면 완료', '후추·바질(있으면), 밥 소량과 함께', '에어프라이어: 내열 용기에 소스·생선 담고 180°C 12분(뚜껑 없이)'] },
  ...
  { id: 'l-pork', title: '돼지 안심 구이 + 쌈', tags: ['고기', '10분'], prep: '안심은 1.5cm 두께로 썰어 소금·후추 해두면 바로 굽기만.',
    ...
    steps: ['안심 1.5cm 두께, 소금·후추, 실온 10분', '팬 중불 예열 1분, 기름 없이(안심은 기름 거의 없음, 코팅팬) 3분', '뒤집어 3분, 뚜껑 덮고 약불 1분 더(속까지 익힘, 단면이 옅은 분홍→흰색)', '마늘은 편 썰어 고기 옆에서 같이 굽기', '쌈채소에 고기·된장 ½작은술·마늘 싸서, 밥·김치와', '에어프라이어: 180°C 12분, 6분에 뒤집기. 두꺼우면 2분 추가'] },
  { id: 'l-chicken-thigh', title: '닭다리살 간장구이', tags: ['고기', '15분'], prep: '닭다리살(정육) 껍질 제거해 냉장. 껍질을 벗기면 지방 절반.',
    ...
    steps: ['닭다리살 껍질 벗기고 두꺼운 부분 칼집, 후추', '팬 중불 예열 1분, 기름 없이 껍질 붙어 있던 면 아래로 4분', '뒤집어 3분, 양파 넣기', '간장 1작은술 + 물 2큰술 + 다진 마늘 붓고 중불 1분 졸이며 끼얹기', '브로콜리는 끓는 물 1분 데치기, 밥과 함께', '에어프라이어: 양념에 10분 재운 뒤 180°C 15분, 8분에 뒤집기'] },
  ...
  { id: 'l-shrimp-garlic', title: '마늘 새우 브로콜리 볶음', tags: ['해산물', '10분'], prep: '냉동 새우·브로콜리 상비. 전날 해동.',
    ...
    steps: ['브로콜리는 끓는 물에 1분 데쳐 건지기', '팬 중불 올리브오일 1작은술, 편 마늘 30초(노릇해지기 직전)', '새우 넣고 센불 2분, 양면이 붉게 오그라들면', '브로콜리 넣고 1분, 소금·후추(페퍼론치노 있으면 좋음)', '밥과 함께', '에어프라이어: 새우·브로콜리·마늘에 기름 버무려 190°C 7분'] },
  ...
  { id: 'l-tofu-steak', title: '두부 스테이크 + 버섯구이', tags: ['가벼움', '15분'], prep: '두부 물기만 빼두기. 새송이 상비.',
    ...
    steps: ['두부는 2cm 두께로 썰어 키친타월 사이에 5분 눌러 물기 제거', '팬 중강불 예열 1분, 올리브오일 ½작은술', '두부 각 면 3분씩(총 6분) 노릇하게. 자주 뒤집지 않기', '두부 꺼내고 새송이 길게 찢어 중불 2분', '간장 ½큰술 뿌려 30초, 후추. 밥 소량과 함께', '에어프라이어: 두부에 기름 살짝 발라 190°C 15분, 8분에 뒤집기(더 바삭)'] },
